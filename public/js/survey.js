...
function checkCommandFields(){
  ...
  $("#command_1").val($("#command_1").val().trim())
  if ($("#command_1").val() != ""){
    hasCommand = true
  }
  $("#command_2").val($("#command_2").val().trim())
  if ($("#command_2").val() != ""){
    hasCommand = true
  }
  $("#command_3").val($("#command_3").val().trim())
  if ($("#command_3").val() != ""){
    hasCommand = true
  }
  return hasCommand
...
function addReplyCommand(){
  var cmds = $("#commands").html()
  cmds += "," + $("#command").val()
  $("#commands").html(cmds)
  alert($("#commands").html())
}
...
function canSendMessages() {
  ...
  if (!checkCommandFields()){
    return alert("Please enter at least one expecting reply!")
  }
